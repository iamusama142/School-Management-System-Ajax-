                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="adfee" name="admission" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Annual Fee</label>
                                        <input type="number" id="anfee" name="annaul" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Tution Fee</label>
                                        <input type="number" id="atfee" name="tution" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-body">
                <form action="/allClassvocuher" method="POST">
                    @csrf
                <div class="row">
                    <div class="container rounded mb-5 p-3 shadow-lg p-3" id="ajaxStudent">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="text-dark ">Class</label>
                                    <select name="program_id" class="form-control" id="programs-dropdown" required>
                                    </select>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label class="text-dark ">Section</label>
                                    <select name="section" class="form-control" id="classes-dropdown" required>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <button class="btn btn-primary" type="submit">Download full Class Voucher</button>
            ...
            $(document).on('click', '.editIcon', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $("#anfee").val(response[0].annualfee);
                        $("#atfee").val(response[0].tutionfee);
                    },
                    error: function() {
                        alert('issue');
                    }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200) {
                            $('.alert-after').append(
                                ' <div id=\"success\" class=\"alert alert-info alert-dismissible fade show\"> <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>Student <strong>Record!</strong> has been Updated Sucessfuly..  </div> '
                            );
                        }
                    },
                    error: function() {
